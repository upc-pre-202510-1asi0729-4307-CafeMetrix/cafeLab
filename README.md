...
#### 5.2.2.4. Development Evidence for Sprint Review.| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Committed on (Date) ||------------|--------|-----------|----------------|-------------------|-------------------|| cafeLab | feat(public): finished all views in cupping sessions page component | a6e53e7 | feat(public): finished all views in cupping sessions page component | Completed implementation of all views for cupping sessions page | May 14, 2025 || cafeLab | feat(public): add the new cupping session button in cupping sessions page component | 454a671 | feat(public): add the new cupping session button in cupping sessions page component | Added new cupping session button functionality | May 14, 2025 || cafeLab | feat(public): add filter feature to cupping sessions page component | 0b7286f | feat(public): add filter feature to cupping sessions page component | Implemented filtering functionality for cupping sessions | May 14, 2025 || cafeLab | feat(public): add cupping sessions page component | 1244538 | feat(public): add cupping sessions page component | Created base cupping sessions page component | May 14, 2025 || cafeLab | feat(public): add cupping sessions component structure | 929a31c | feat(public): add cupping sessions component structure | Set up initial structure for cupping sessions | May 14, 2025 || cafeLab | fix(dashboard): correct title of cards | 8ba9c68 | fix(dashboard): correct title of cards | Fixed card titles in dashboard | May 14, 2025 || cafeLab | fix(dashboard): correct navbar and color of exit button | b64833a | fix(dashboard): correct navbar and color of exit button | Updated navbar and exit button styling | May 14, 2025 || cafeLab | feat(public): add welcome barsta page component | e3891d3 | feat(public): add welcome barsta page component | Added welcome barista page component | May 14, 2025 || cafeLab | fix(payments): correct to bold font type to mat cart titles | 5f4cf56 | fix(payments): correct to bold font type to mat cart titles | Updated font weight for cart titles | May 14, 2025 || cafeLab | feat(payment): add select payment screen and navbar | 0a008de | feat(payment): add select payment screen and navbar | Implemented payment selection screen | May 14, 2025 || cafeLab | feat(ui): add angular material | 8621e4e | feat(ui): add angular material | Added Angular Material UI framework | May 14, 2025 || cafeLab | feat: add files | befed27 | feat: add files | Added new project files | May 15, 2025 || cafeLab | feat(i18n): add language switcher | 9d1d245 | feat(i18n): add language switcher | Implemented language switching functionality | May 15, 2025 || cafeLab | feat(i18n): add i18n support through ngx-translate | 6655b9f | feat(i18n): add i18n support through ngx-translate | Added internationalization support | May 15, 2025 || cafeLab | feat(environments): add courses endpoint path | 010e33f | feat(environments): add courses endpoint path | Added API endpoint for courses | May 15, 2025 || cafeLab | feat(fake-api): add json-server and configure fake api | b3c9d1f | feat(fake-api): add json-server and configure fake api | Set up mock API with json-server | May 15, 2025 || cafeLab | feat(public): finished all views for production cost management page component | 34ffae4 | feat(public): finished all views for production cost management page component | Completed production cost management views | May 15, 2025 || cafeLab | feat(public): add step 3 and 4 to production cost management page component | d15cca1 | feat(public): add step 3 and 4 to production cost management page component | Added steps 3 and 4 to cost management | May 15, 2025 || cafeLab | feat(public): add the step 1 and 2 to production cost management page component | b55fef6 | feat(public): add the step 1 and 2 to production cost management page component | Added steps 1 and 2 to cost management | May 15, 2025 || cafeLab | feat(shared): import navbar component from welcome-barista branch | b750203 | feat(shared): import navbar component from welcome-barista branch | Imported shared navbar component | May 14, 2025 || cafeLab | feat(public): add inicial version off product cost management page component | 8c806f9 | feat(public): add inicial version off product cost management page component | Initial version of cost management page | May 14, 2025 || cafeLab | feature: new branch | 2bbcfde | feature: new branch | Created new feature branch | May 15, 2025 || cafeLab | Added recipes and portfolio page | ba4dce7 | Added recipes and portfolio page | Added recipes and portfolio features | May 15, 2025 || cafeLab | feat(public): add the register consume feature button to inventory page component | 443a29d | feat(public): add the register consume feature button to inventory page component | Added consume registration button | May 15, 2025 || cafeLab | feat(public): add all view for inventory page component | 56de333 | feat(public): add all view for inventory page component | Completed inventory page views | May 15, 2025 || cafeLab | feat(shared): import navbar component from welcome-barista branch | b5ce673 | feat(shared): import navbar component from welcome-barista branch | Imported navbar for inventory page | May 15, 2025 || cafeLab | feat(public): add initial structure for inventory page component | a91f173 | feat(public): add initial structure for inventory page component | Set up inventory page structure | May 15, 2025 |#### 5.2.2.8. Team Collaboration Insights during Sprint.
<table border="1">
  <tr>
    <th>Alumno</th>
    <th>Actividad</th>
